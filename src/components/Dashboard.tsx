        ...
        >
          ...
          <nav className="mt-6 space-y-4">
            {navigationItems.map((item, index) => (
              <button
                key={index}
                className="flex items-center space-x-2 text-gray-700 text-xl hover:bg-blue-500 hover:text-white transition-colors p-2 rounded-md w-2/3"
              >
                <item.icon />
          ...
          <div className="mt-20">
            <button className="flex items-center space-x-2 text-xl text-gray-800 hover:bg-blue-500 hover:text-white transition-colors p-2 rounded-md w-2/3">
              <IoIosCall />
              <span>Support</span>
            </button>
            <button className="flex items-center space-x-2 text-xl text-gray-800 mt-2 hover:bg-blue-500 hover:text-white transition-colors p-2 rounded-md w-2/3">
              <FaSignOutAlt />
              <span>Logout</span>
            </button>
          </div>
        ...
        <main className="lg:col-span-3 bg-white p-6 rounded-md">
          <div className="flex justify-between items-center flex-wrap gap-4">
            ...
            <div className="flex space-x-3">
              <button className="flex items-center bg-white text-sm border border-gray-300 text-gray-600 px-4 py-2 rounded-md">
            ...
            {repositories.map((repo, index) => (
              ...
              >
                <div>
                  ...
                  <div className="text-xl text-gray-800 flex items-center space-x-4 flex-nowrap">
                    <span className="flex items-center space-x-2">
                      <span>{repo.lang}</span>
                      <span className="w-2 h-2 bg-blue-500 rounded-full inline-block"></span>
                    </span>
                    <span className="flex items-center space-x-2">
                      <FaDatabase className="text-gray-800" />
                      <span>{repo.size}</span>
                    </span>
                    <span className="flex items-center space-x-2">
